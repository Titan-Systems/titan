...
PRIVS_GRANTABLE_BY_ACCOUNTADMIN_ONLY = {
    AccountPriv.BIND_SERVICE_ENDPOINT,
    AccountPriv.CREATE_ACCOUNT,
    AccountPriv.CREATE_COMPUTE_POOL,
    AccountPriv.CREATE_DATABASE,
    AccountPriv.CREATE_FAILOVER_GROUP,
    AccountPriv.CREATE_REPLICATION_GROUP,
    AccountPriv.CREATE_DATA_EXCHANGE_LISTING,
    AccountPriv.CREATE_INTEGRATION,
    AccountPriv.CREATE_SHARE,
    AccountPriv.EXECUTE_ALERT,
    AccountPriv.EXECUTE_MANAGED_TASK,
    AccountPriv.EXECUTE_TASK,
    AccountPriv.IMPORT_SHARE,
    AccountPriv.MANAGE_WAREHOUSES,
    AccountPriv.MONITOR_EXECUTION,
    AccountPriv.MONITOR_USAGE,
}
...
def priv_must_be_granted_by_accountadmin(priv: str):
    try:
        priv = AccountPriv(priv)
    except ValueError:
        return False
    return priv in PRIVS_GRANTABLE_BY_ACCOUNTADMIN_ONLY
